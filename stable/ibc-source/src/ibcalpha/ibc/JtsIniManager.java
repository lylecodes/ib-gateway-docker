    ...
    */
    ...
    private static List<JtsIniSectionSetting> getMissingSettings() {
        ...
        if (SessionManager.isFIX()) {
            ...
            // CUSTOM MODIFICATION for Railway IPv6 support:
            // Comment out TrustedIPs enforcement that hardcodes 127.0.0.1
            /*
            ...
            */
            ...
            if (SessionManager.isGateway()){
                // CUSTOM MODIFICATION for Railway IPv6 support:
                // Comment out TrustedIPs enforcement that hardcodes 127.0.0.1
                // This allows IB Gateway to accept connections from Railway's IPv6 private network
                // Original code forced: trustedIPs = LOCAL_HOST + (...) = "127.0.0.1,..."
                // which blocks all non-localhost connections
